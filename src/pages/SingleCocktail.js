        ...
        <div className="drink-info">
          ...
          <p>
            ...
            instructionsArr.map((instruction, index) => {
              return instruction && <div style={{ marginLeft: '120px' }}><span key={index}>{index+1} . {instruction}</span><br/></div>;
              })
            }
          </p>
          <p>
            ...
            ingredients.map((ingredient, index) => {
              return ingredient && <div style={{ marginLeft: '120px' }}><span key={index}>{index+1} . {ingredient}</span><br/></div>;
              })
          }
          </p>
